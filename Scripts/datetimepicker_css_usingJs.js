...
//Date created: 16-Nov-2013 23:19
//Creator: TengYong Ng
...
var CalWidth = 228;// calendar width
...
var SpanBorderColor = "#6091BA";//span border color
var SpanBgColor = "#6091BA"; //span background color
var MonthYearColor = "#cc0033"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#6091BA"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#6091BA"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#6091BA"; //Background color of Saturday.
var WeekDayColor = "#FFFFFF"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#86b7c6"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#8DD53C"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#6091BA"; //color when mouse move over.
...
function RenderCssCal(bNewCal)
{
	...
	vCalHeader = "<table style='background-color:"+CalBgColor+";top:500px; width:200px;padding:0;margin:5px auto 5px auto'><tbody>";
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime += "<td width='40px'><input type='text' name='hour' maxlength=2 size=1 style=\"WIDTH:40px\" value=" + showHour + " onkeyup=\"javascript:Cal.SetHour(this.value)\">";
		vCalTime += "</td><td style='font-weight:bold;text-align:center;padding-left:0 2px'>:</td><td width='40px'>";
		vCalTime += "<input type='text' name='minute' maxlength=2 size=1 style=\"WIDTH: 40px\" value=" + Cal.Minutes + " onkeyup=\"javascript:Cal.SetMinute(this.value)\">";
		...
		vCalTime += "<tr><td colspan='8' style=\"text-align:center;\"><input style='width:60px;margin-left:50px;font-size:12px;' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"OK\">&nbsp;<input style='width:60px;font-size:12px;' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancel\"></td></tr>";
	}
